...
public class NetworkManagerLobby : NetworkManager
{
    ...
    [Header("Room")]
    [SerializeField] public NetworkRoomPlayerLobby roomPlayerPrefab = null;

    [Header("Game")]
    [SerializeField] public NetworkGamePlayerLobby gamePlayerPrefab = null;
        ...
        foreach (var prefab in spawnPrefabs)
            {
                ...
                GameObject treeGo = Instantiate(prefab, new Vector3(x++, 0, 0), Quaternion.identity);
